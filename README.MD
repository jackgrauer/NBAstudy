...
$$
\text{WageTax}{it} = \beta{0,1} + \beta_{1,1} \text{NBA Team}i + \beta{2,1} \text{Post-2016}t + \beta{3,1} (\text{NBA Team}_i \times \text{Post-2016}t) + \epsilon{it,1}
$$

Sales Tax Model:

$$
\text{SalesTax}{it} = \beta{0,2} + \beta_{1,2} \text{NBA Team}i + \beta{2,2} \text{Post-2016}t + \beta{3,2} (\text{NBA Team}_i \times \text{Post-2016}t) + \epsilon{it,2}
$$

Where:

\text{WageTax}_{it} represents the wage tax revenue in a given city i at time t.

\text{SalesTax}_{it} represents the sales tax revenue in a given city i at time t.
